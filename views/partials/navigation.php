<nav class="bg-blue-300 mt-0">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="mx-12 hidden md:block">
                    <div class="flex text-xl items-baseline space-x-8">
                        <a href="/" class=" text-lg text-gray-700 rounded-md px-3 py-2 text-lg font-medium"
                            aria-current="page">Αρχική</a>
                        <a href="products.php"
                            class="font-bold text-gray-700 hover:font-bold hover:text-blue-500 rounded-md px-3 py-2 text-lg font-medium">Λίστα
                            προϊόντων</a>
                    </div>
                </div>
    ...
    <div class="sm:block toggler md:hidden" id="mobile-menu">
        ...
        <div class="flex flex-col px-2 pb-3 pt-2 sm:px-3 ">
            <a href="/" class="text-base text-gray-700 block px-3 py-2 text-base font-medium"
                aria-current="page">Αρχική</a>
            <a href="products.php"
                class="text-base text-gray-700 hover:text-blue-500 hover:font-bold block  rounded-md px-3 py-2 text-base font-medium">Λίστα
                προϊόντων</a>
        </div>
    </div>
</nav>
